  ...
  handleSubmit(event) {
    ...
    fetch('http://localhost:3001/allBooks')
      ...
      .then(res => {
        ...
        this.props.sendResultsToHome(filtered)
  ...
  render() {
    return (
      <form className="search" id="searchform" onSubmit={this.handleSubmit}>
        ...
        <button type="submit">near 55102</button>{' '}
        {/* TODO: opens SearchArea modal at bottom of screen on click */}
        <input
          id="forminput"
          type="text"
          placeholder="search a book title, author or publisher"
        />
      </form>
    )
  }
